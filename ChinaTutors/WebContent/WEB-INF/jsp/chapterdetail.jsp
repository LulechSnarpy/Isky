        ...
        <section class="rt_wrap content mCustomScrollbar">
            <div class="rt_content">
                <fieldset>
                    ...
                    <p><span>课程编号 &nbsp;</span>${course.courseId}</p>
                    <p><span>章节编号 &nbsp;</span>${c.chapterId}</p>
                    <p><span>章节 &nbsp;</span>${c.chapter}</p>
                    <p><span>章节名称 &nbsp;</span>${c.title}</p>
                    <p><span>章节内容 &nbsp;</span>${c.content}</p>
                </fieldset>
                <a href="showAllChapters?courseId=${course.courseId}">返回</a>
            </div>
        </section>
    </body>
</html>
