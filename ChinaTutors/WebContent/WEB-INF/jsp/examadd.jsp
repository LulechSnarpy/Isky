    ...
    <body>
        ...
        <section class="rt_wrap content mCustomScrollbar">
            <div class="rt_content">
                <fieldset>
                    <legend  style="font-weight: bold;font-size: 20px;color:brown;">考试信息</legend>
                    <form action="examadd">
                        <span>考试码：</span><input type="text" name="ECode">
                        <br><br>
                        <span>考试时长：</span><input type="text" name="ETime">
                        <br><br>
                        <span>考试章节编号：</span><input type="text" name="chapterId" value="CHAP00000001">
                        <br><br> 
