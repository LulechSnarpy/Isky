        ...
        <section class="rt_wrap content mCustomScrollbar">
            <div class="rt_content">
                <fieldset>
                    ...
                    <form action="addchapers?courseId=${course.courseId}" method="post">
                        <span>章节编号：</span><input type="text" name="chapterId" value="CHAP00000001">
                        <br><br>
                        <span>章节：</span><input type="text" name="chapter" value="Chemistry">
                        <br><br>
                        <span>章节名：</span><input type="text" name="title" value="chapterName">
                        <br><br> 
                        <span>章节内容：</span><input type="text" name="content">
                        <br><br>
