                    ...
                    <table>
                        ...
                        <c:forEach items="${oList}" var="c">
                            <tr id="${c.courseId}">
                                ...
                                <td>${c.title}&nbsp;</td>                  
                                <td>
                                    <a href="showAllChapters?courseId=${c.courseId}">查看详情</a> &nbsp;
                                    <a href="forupdatecourse?courseId=${c.courseId}">编辑</a> &nbsp;
                                    <a href="deletecourse?courseId=${c.courseId}">删除</a> &nbsp;                          
                                </td>
                            </tr>                   
                        </c:forEach>
                    </table>
                </fieldset>
                <a href="foraddcourse">添加</a>
            </div>
        </section>
    </body>
</html>
